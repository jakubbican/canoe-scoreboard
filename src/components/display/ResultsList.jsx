  ...
  const getCategoryTitle = () => {
    ...
    if (data.RaceName) {
      ...
      return data.RaceStatus ? 
        ...
        `${prefix}Results: ${data.RaceName}`;
    }
    
    return categoryInfo ? `${categoryInfo} - Results` : 'Results';
  };
        ...
        {resultsToShow.map((competitor, index) => {
          ...
          return (
            <div 
              ...
              className={`result-row ${parseInt(competitor.Bib) === highlightBib ? 'highlight' : ''}`}
            >
              <div className="result-rank">
                {competitor.Rank ? `${competitor.Rank}.` : ''}
              </div>
              
              <div className="result-bib">
                {competitor.Bib}
              </div>
